    ...
    <div className="sm:w-[400px] w-[100%] relative   flex flex-col mx-auto">
      ...
      >
        <button
          ...
          className="text-white outline-none border-0 active:scale-110 active:text-red-500 absolute left-5 top-0 box-border p-2 hidden sm:flex text-2xl font-bold"
        >
          <FaAnglesRight />
        </button>
        <div className="  box-border flex flex-col text-white w-full overflow-hidden gap-5 sm:p-2 justify-center sm:justify-normal sm:h-[400px] sm:items-start  items-center text-2xl rounded-3xl">
          <button
            className="m-2 hover:scale-110 hover:text-red-600 flex items-center outline-none"
            onClick={() => handleButtonClick(Profile)}
          >
            <FaRegUserCircle />{" "}
            <span className="hidden md:flex  m-2 sm:flex text-sm">About</span>
          </button>
          ...
          >
            <FaCircleNodes />{" "}
            <span className="hidden md:flex m-2 sm:flex text-sm">Projects</span>
          </button>
          <button
            className="m-2 hover:scale-110 hover:text-red-600 flex items-center outline-none"
          ...
          >
            <FaCode />{" "}
            <span className="hidden md:flex m-2 sm:flex text-sm">Skills</span>
          </button>
          <button
            className="m-2 hover:scale-110 hover:text-red-600 flex items-center outline-none"
          ...
          >
            <FaEnvelope />{" "}
            <span className="hidden md:flex m-2 sm:flex text-sm">
              ContactUs
            </span>
          </button>
        </div>
      ...
      <div className="fixed bg-[#0e1630] sm:z-30 z-50 items-center top-0 md:flex w-full sm:flex hidden">
        <span className="relative left-0 top-0 drop-shadow-4xl">
