...
const ResumeFile = 'https://drive.google.com/uc?id=1nXES0rlv73X53QzgCagH9AN-e8WymXtn'
...
const SocilLinks: React.FC = () => {
  ...
  return (
    <div className='flex list-none items-center sm:text-3xl text-4xl text-white'>
                ...
                <button onClick={()=>{ResumeDownload(ResumeFile)}} className='bg-green-500 outline-none hover:bg-green-600 box-border items-center flex font-semibold text-lg p-1 rounded-2xl'>
                  <span>Resume</span> <FaFileArrowDown/>
                  </button>
