...
const SocilLinks: React.FC = () => {
  return (
    <div className='flex list-none items-center sm:text-3xl text-4xl text-white'>
                ...
                <button className='bg-green-500 outline-none hover:bg-green-600 box-border font-semibold text-lg p-1 rounded-2xl'><a className='flex items-center' href="/vitthalkokare.pdf" download={'/vitthalkokare.pdf'}>Resume <FaFileArrowDown/></a></button>
